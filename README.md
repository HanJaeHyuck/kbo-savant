...
- **투구 탄착군**: 구종별 KDE 밀도 히트맵(가우시안 스무딩)
...
- **좌측 히어로**: 사진·바이오·커리어표(W/L/ERA/G/GS/SV/IP/SO/WHIP) + Pitch Usage(vs 좌/우타) + Player Apps
...
GET /api/players/{id}/pitches?season=      투구/탄착군/존 그리드/무브먼트/구속트렌드/사용률
